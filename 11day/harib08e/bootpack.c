...
void HariMain(void){
  ...
  make_window8(buf_win, 160, 68, "error");
  putfonts8_asc(buf_win, 160, 24, 28, COL8_000000, "Welcome to");
	putfonts8_asc(buf_win, 160, 24, 44, COL8_000000, "  Minoeru OS");
    ...
    if (fifo8_status(&keyfifo) + fifo8_status(&mousefifo) == 0){
      ...
      if (fifo8_status(&keyfifo) != 0) {
        ...
        if (mouse_decode(&mdec, i) != 0){
          ...
          putfonts8_asc(buf_back, binfo->scrnx, 32, 16, COL8_FFFFFF, s);//マウスカーソルの移動
